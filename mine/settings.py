...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-(!^u(&=to#9ua@o(#v4ye$_x*v19d+8+llfx)ecdh^r0nv*72y')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = 'RENDER' not in os.environ

ALLOWED_HOSTS = ['49.235.133.21', 'fan-le-me.site', "127.0.0.1", "fanleme.wuzm219.cn","localhost"]
...
# SECURE_SSL_REDIRECT = True  # 已启用HTTPS
# SESSION_COOKIE_SECURE = True  # 已启用HTTPS
# CSRF_COOKIE_SECURE = True  # 已启用HTTPS